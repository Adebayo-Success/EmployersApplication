...
namespace ConsoleAdoDotNet
{
    public class EmployeeService
    {
        ...
        public async Task AddEmployee()
        {
            ...
            {
                string query = "INSERT INTO Employees (Id, FirstName, LastName, Email, Department, HiredDate, Salary) " +
                                "VALUES (@Id, @FirstName, @LastName, @Email, @Department, @HiredDate, @Salary)";
